          ...
          input: {
            ...
            description:
              Object.entries(paykitCommandFields)
                ...
                .join('; ') +
              '. link.prepareRecovery uses restored-side, healthy-side, restored-side order. Require both recoveryPreparation.readyForHandshake projections before link.initiate and link.accept; preparation never advances a handshake.' +
